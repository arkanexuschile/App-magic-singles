...
export const PRODUCT_METAFIELD_DEFINITIONS: MetafieldDefinitionSpec[] = [
  ...
  { namespace: "custom", key: "mana_cost", name: "Coste de maná", type: "single_line_text_field" },
  ...
  { namespace: "custom", key: "oracle_text", name: "Texto de la carta", type: "multi_line_text_field" },
  ...
  { namespace: "custom", key: "full_art", name: "Full art", type: "boolean" },
  { namespace: "custom", key: "textless", name: "Sin texto", type: "boolean" },
  { namespace: "custom", key: "promo", name: "Promo", type: "boolean" },
  { namespace: "custom", key: "scryfall_meta", name: "Metadatos Scryfall (JSON)", type: "json", description: "Datos crudos de Scryfall para la carta." },
  { namespace: "custom", key: "eur", name: "Precio EUR", type: "number_decimal" },
